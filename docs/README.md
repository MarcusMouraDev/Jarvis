# Documentação do Jarvis V23

Esta documentação descreve a evolução segura do Jarvis sem substituir o comportamento V23 existente.

- [Visão de produto](product/vision.md)
- [Arquitetura](architecture/overview.md)
- [Segurança](security/safe-agent-core.md)
- [Roadmap](roadmap.md)
- [Pesquisa e decisões](research/decisions.md)
